...
class WeTypecho_Plugin implements Typecho_Plugin_Interface
{
    ...
    {        
        ...
        $hiddenShare = new Typecho_Widget_Helper_Form_Element_Text('hiddenShare', NULL, '1', _t('是否开启小程序端分享，转发功能，1为开启，0为关闭。为了过微信审核你懂的^-^，可在过审核后打开该功能'),  _t('审核时建议关闭，防止微信判定小程序有诱导用户分享的嫌疑，审核通过后再开启。'));
